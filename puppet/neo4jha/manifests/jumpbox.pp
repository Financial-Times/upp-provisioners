class neo4jha::jumpbox {
  ...
  cron { 'authorized_keys-service':
    command => "/usr/bin/curl -s https://raw.githubusercontent.com/Financial-Times/up-neo4j-ha-cluster/master/sh/authorized_keys.service.sh | /bin/bash | tee -a /var/log/jumpbox.log",
    user    => 'root',
    minute  => '*/5',
  }
